    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          {/* 店舗情報 */}
          <div>
            <p className="text-[#C9A84C]/40 text-[8px] tracking-[0.5em] uppercase mb-4">
              Premium Entertainment
            </p>
            <h3
              className="text-xl font-light tracking-[0.25em] text-[#C9A84C] mb-5"
          ...
          {/* パートナーリンク */}
          <div>
            <p className="text-[#C9A84C]/50 text-[9px] tracking-[0.4em] uppercase mb-5">
              Partner Links
            </p>
            {partners.length > 0 ? (
