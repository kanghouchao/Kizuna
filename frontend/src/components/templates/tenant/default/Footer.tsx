    ...
    <footer className="bg-gray-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Partner Links */}
          <div>
            <h4 className="text-lg font-semibold mb-4">パートナーリンク</h4>
            {partners.length > 0 ? (
              ...
              <p className="text-gray-500 text-sm">リンクはありません</p>
            )}
          </div>
          ...
          <div>
            ...
            {sns.length > 0 ? (
              ...
              <p className="text-gray-500 text-sm">SNSリンクはありません</p>
            )}
          </div>
        </div>
      </div>
...
function getSnsIcon(platform: string) {
  ...
  return <span className="text-sm font-semibold">{platform.charAt(0).toUpperCase()}</span>;
}
