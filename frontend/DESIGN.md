...
- The duration **must** come from the call: the auto-dismiss timer is armed before the render pass, so a value swapped in while rendering would not take.
